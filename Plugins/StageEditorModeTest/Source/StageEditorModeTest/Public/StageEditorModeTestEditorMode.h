...
#include "StageEditorModeTestEditorMode.generated.h"
 ...
 */
UCLASS()
class UStageEditorModeTestEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_StageEditorModeTestEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UStageEditorModeTestEditorMode();
	virtual ~UStageEditorModeTestEditorMode();
