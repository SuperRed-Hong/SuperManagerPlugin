...
#include "StageEditorModeTestInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UStageEditorModeTestInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UStageEditorModeTestInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UStageEditorModeTestInteractiveTool* NewTool = NewObject<UStageEditorModeTestInteractiveTool>(SceneState.ToolManager);
...
void UStageEditorModeTestInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UStageEditorModeTestInteractiveTool::Setup()
{
	...
	Properties = NewObject<UStageEditorModeTestInteractiveToolProperties>(this, "Measurement");
...
void UStageEditorModeTestInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UStageEditorModeTestInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UStageEditorModeTestInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UStageEditorModeTestInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UStageEditorModeTestInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UStageEditorModeTestInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UStageEditorModeTestInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UStageEditorModeTestInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UStageEditorModeTestInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
