...
#include "StageEditorModeTestInteractiveTool.generated.h"
 ...
 */
UCLASS()
class STAGEEDITORMODETEST_API UStageEditorModeTestInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class STAGEEDITORMODETEST_API UStageEditorModeTestInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UStageEditorModeTestInteractiveToolProperties();
 ...
 */
UCLASS()
class STAGEEDITORMODETEST_API UStageEditorModeTestInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UStageEditorModeTestInteractiveToolProperties> Properties;
